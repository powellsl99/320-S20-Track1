...
import StudentProfile from "../ProfileSettings/StudentProfileSettings.js"; //temp
import Academics from "../ProfileSettings/AcademicSettings.js"; //temp
      ...
      >
        <div>
          ...
          <List>
            ...
            <ListItem
              button
              onClick={() => setPage("Supporter Information")}
              key={2}
            >
            ...
            <ListItem
              button
              onClick={() => setPage("Appointment Blocks")}
              key={3}
            >
              <ListItemText primary={"Appointment Blocks"} />
            </ListItem>
            <ListItem button onClick={() => setPage("TESTING")} key={4}>
