...
def lambda_handler(event, context):
    ...
    if toCancel:
        ...
        send_cal_email(supp, supp_email, stud_name, stud_email, appt_time, duration, location, appt_type, resend=requester_email)
    else:
...
def send_cal_email(supp, supp_email, student, student_email, appt_time, duration, location, appt_type, toCancel=False, resend=None):
    ...
    description = "DESCRIPTION:"+appt_type+" appointment between "+supp+" and student(s) "+", ".join(students)+" "+CRLF
    attendee = ""
    ...
    msg['Subject'] = "Appointment Calendar Invite"#+dtstart
    msg['From'] = fro
